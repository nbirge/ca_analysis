...
np.save(file=path+'multi_'+str(run)+'_window-'+str(twindow)+'_thresh-{:0.1f}'.format(threshold),arr=multi)       ####This is the array of interest
np.save(file=path+'pre-multi_'+str(run)+'_window-'+str(twindow)+'_thresh-{:0.1f}'.format(threshold),arr=cut)
